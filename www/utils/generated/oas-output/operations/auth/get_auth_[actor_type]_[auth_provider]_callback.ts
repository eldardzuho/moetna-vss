 ...
 * description: Retrieve a list of callbacks in a [actor_type]. The callbacks can be filtered by fields like FILTER FIELDS. The callbacks can also be paginated.
