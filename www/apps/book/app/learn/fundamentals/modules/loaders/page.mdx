...
As of [Medusa v2.11.0](https://github.com/medusajs/medusa/releases/tag/v2.11.0), Awilix dependencies are included in the `@moetnavss/framework` package. If you're using an older version of Medusa, change the import statement to `awilix`.
