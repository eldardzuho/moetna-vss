...
As of [Medusa v2.11.0](https://github.com/medusajs/medusa/releases/tag/v2.11.0), MikroORM dependencies are included in the `@moetnavss/framework` package. If you're using an older version of Medusa, change the import statement to `@mikro-orm/knex`.
...
The entity manager is injected to the `sharedContext.manager` property, which is an instance of [EntityManager from the `@moetnavss/framework/mikro-orm/knex` package](https://mikro-orm.io/api/knex/class/EntityManager).
...
import { MedusaService } from "@moetnavss/framework/utils"
import Post from "./models/post"
import { DAL } from "@moetnavss/framework/types"
...
import { Context } from "@moetnavss/framework/types"
import { EntityManager } from "@moetnavss/framework/mikro-orm/knex"
import { IsolationLevel } from "@moetnavss/framework/mikro-orm/core"
