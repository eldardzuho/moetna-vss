...
import { defineWidgetConfig } from "@moetnavss/admin-sdk"
import { Button, Container } from "@moetnavss/ui"
...
This is a known issue when using `pnpm`. To fix it, you need to install the `@tanstack/react-query` package manually. Make sure to install the same version installed in [@moetnavss/dashboard](https://github.com/medusajs/medusa/blob/d58462c9c91a3e335d03f758438e109caad1f839/packages/admin/dashboard/package.json#L54).
