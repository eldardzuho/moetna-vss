...
As of [v2.13.0](https://github.com/medusajs/medusa/releases/tag/v2.13.0), Medusa exports [Zod](https://zod.dev/) from the `@moetnavss/framework` package.
...
Starting in v2.13.0, you can import Zod from `@moetnavss/framework/zod` in your backend customizations. For example:
