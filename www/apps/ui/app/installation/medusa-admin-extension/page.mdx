...
The `@moetnavss/ui` and `@moetnavss/icons` packages are already installed as dependencies of the `@moetnavss/admin-sdk` package in your Medusa project. They're installed by default in your Medusa plugins as well.
