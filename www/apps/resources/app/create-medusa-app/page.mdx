  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        ...
        Specify the Medusa version to install in the project. The specified version will be used for every `@moetnavss/*` package in the Medusa and Next.js Starter projects.
...
To install a specific version of Medusa, use the `--version` option. This will install the specified version for every `@moetnavss/*` package in the Medusa and Next.js Starter projects. For example:
