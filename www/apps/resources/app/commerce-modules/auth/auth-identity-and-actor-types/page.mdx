...
When you protect routes with the [authenticate middleware](!docs!/learn/fundamentals/api-routes/protected-routes), you specify in its first parameter the actor type that must be authenticated to access the API routes.
...
Learn how to create a custom actor type in the [Create Manager Actor Type guide](../create-actor-type/page.mdx).