...
To retrieve the inventory quantity of a product variant, use the `getVariantAvailability` utility function imported from `@moetnavss/framework/utils`. It returns the available quantity of the product variant.
...
import { getVariantAvailability } from "@moetnavss/framework/utils"
...
import { MedusaStoreRequest, MedusaResponse } from "@moetnavss/framework/http"
import { getVariantAvailability } from "@moetnavss/framework/utils"
