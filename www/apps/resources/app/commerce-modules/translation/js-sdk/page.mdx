...
Use the following methods or properties to send requests to Translation related API routes in your Medusa application. They are provided by the `@moetnavss/js-sdk` package.
