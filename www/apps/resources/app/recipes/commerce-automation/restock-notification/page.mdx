...
import { getVariantAvailability, MedusaError } from "@moetnavss/framework/utils"
...
```ts title="src/modules/restock/service.ts"
// other imports...
import { InjectManager, MedusaContext } from "@moetnavss/framework/utils"
...
import { getVariantAvailability, promiseAll } from "@moetnavss/framework/utils"
import { createStep, StepResponse } from "@moetnavss/framework/workflows-sdk"
