...
import { ProductOptionValueDTO } from "@moetnavss/framework/types"
...
import { acquireLockStep, releaseLockStep, useQueryGraphStep } from "@moetnavss/medusa/core-flows"
...
import { simpleHash, Modules } from "@moetnavss/framework/utils"
import { 
  ...
  modules: [
    // ...
    {
      ...
      options: {
        providers: [
          {
            resolve: "@moetnavss/caching-redis",
            id: "caching-redis",
            options: {
