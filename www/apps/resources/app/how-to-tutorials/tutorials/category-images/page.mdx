...
import { DetailWidgetProps, AdminProductCategory } from "@moetnavss/framework/types"
...
import { FocusModal, Button, Heading, toast } from "@moetnavss/ui"
...
```tsx title="src/admin/components/category-media/category-image-item.tsx"
import { Checkbox, clx } from "@moetnavss/ui"
```
...
```tsx title="src/admin/components/category-media/category-media-modal.tsx"
import { CommandBar } from "@moetnavss/ui"
```
...
import { deleteFilesWorkflow, useQueryGraphStep } from "@moetnavss/medusa/core-flows"
