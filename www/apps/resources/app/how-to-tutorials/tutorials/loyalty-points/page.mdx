...
import { MedusaError, MedusaService } from "@moetnavss/framework/utils"
...
Medusa provides the `useQueryGraphStep` and `updatePromotionsStep` in its `@moetnavss/medusa/core-flows` package. So, you'll only implement the other steps.
...
import { CustomerDTO } from "@moetnavss/framework/types"
...
import { PromotionDTO, CustomerDTO, CartDTO } from "@moetnavss/framework/types"
...
import { createWorkflow, when } from "@moetnavss/framework/workflows-sdk"
import { updatePromotionsStep, useQueryGraphStep } from "@moetnavss/medusa/core-flows"
...
Most of the workflow's steps are either provided by Medusa in the `@moetnavss/medusa/core-flows` package or steps you've already implemented. You only need to implement the `getCartLoyaltyPromoAmountStep` step.
...
import { PromotionDTO, CustomerDTO } from "@moetnavss/framework/types"
import { MedusaError } from "@moetnavss/framework/utils"
import { createStep, StepResponse } from "@moetnavss/framework/workflows-sdk"
import LoyaltyModuleService from "../../modules/loyalty/service"
import { LOYALTY_MODULE } from "../../modules/loyalty"
