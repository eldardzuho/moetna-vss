...
This documentation provides a reference to the `deleteCustomerGroupStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more customer groups.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteCustomerGroupStep } from "@moetnavss/medusa/core-flows"
