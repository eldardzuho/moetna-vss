...
This documentation provides a reference to the `removeLineItemAdjustmentsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step removes line item adjustments from a cart.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { removeLineItemAdjustmentsStep } from "@moetnavss/medusa/core-flows"
