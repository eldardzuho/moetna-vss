...
This documentation provides a reference to the `createCartCreditLinesWorkflow`. It belongs to the `@moetnavss/medusa/core-flows` package.

This workflow creates one or more credit lines for a cart.

<SourceCodeLink link="https://github.com/medusajs/medusa/blob/87b5b454afdf7533a167fcb48e069f8c28e4b7e9/packages/core/core-flows/src/cart/workflows/create-cart-credit-lines.ts#L31" />
...
import { createCartCreditLinesWorkflow } from "@moetnavss/medusa/core-flows"
