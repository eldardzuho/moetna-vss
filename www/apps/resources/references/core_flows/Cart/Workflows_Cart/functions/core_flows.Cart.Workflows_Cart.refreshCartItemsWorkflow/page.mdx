...
This documentation provides a reference to the `refreshCartItemsWorkflow`. It belongs to the `@moetnavss/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/87b5b454afdf7533a167fcb48e069f8c28e4b7e9/packages/core/core-flows/src/cart/workflows/refresh-cart-items.ts#L128" />
