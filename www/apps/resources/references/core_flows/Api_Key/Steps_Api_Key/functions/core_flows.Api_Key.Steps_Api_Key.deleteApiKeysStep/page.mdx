...
This documentation provides a reference to the `deleteApiKeysStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more API keys.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteApiKeysStep } from "@moetnavss/medusa/core-flows"
