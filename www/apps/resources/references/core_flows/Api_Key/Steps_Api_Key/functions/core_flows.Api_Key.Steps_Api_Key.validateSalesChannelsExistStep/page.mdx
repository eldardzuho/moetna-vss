...
This documentation provides a reference to the `validateSalesChannelsExistStep`. It belongs to the `@moetnavss/medusa/core-flows` package.
...
import { validateSalesChannelsExistStep } from "@moetnavss/medusa/core-flows"
