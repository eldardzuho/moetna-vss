...
This documentation provides a reference to the `deleteFulfillmentSetsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more fulfillment sets.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteFulfillmentSetsStep } from "@moetnavss/medusa/core-flows"
