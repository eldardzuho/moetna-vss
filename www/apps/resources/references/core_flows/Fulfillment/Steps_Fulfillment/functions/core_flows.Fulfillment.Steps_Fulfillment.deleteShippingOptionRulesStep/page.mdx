...
This documentation provides a reference to the `deleteShippingOptionRulesStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more shipping option rules.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteShippingOptionRulesStep } from "@moetnavss/medusa/core-flows"
