...
This documentation provides a reference to the `deleteShippingOptionsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more shipping options.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteShippingOptionsStep } from "@moetnavss/medusa/core-flows"
