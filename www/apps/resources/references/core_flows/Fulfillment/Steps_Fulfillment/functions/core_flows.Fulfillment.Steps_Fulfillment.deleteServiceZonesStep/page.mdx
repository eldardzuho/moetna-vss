...
This documentation provides a reference to the `deleteServiceZonesStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more service zones.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteServiceZonesStep } from "@moetnavss/medusa/core-flows"
