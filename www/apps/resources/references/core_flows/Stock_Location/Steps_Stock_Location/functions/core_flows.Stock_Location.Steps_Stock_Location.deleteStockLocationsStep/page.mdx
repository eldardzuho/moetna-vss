...
This documentation provides a reference to the `deleteStockLocationsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more stock locations.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteStockLocationsStep } from "@moetnavss/medusa/core-flows"
