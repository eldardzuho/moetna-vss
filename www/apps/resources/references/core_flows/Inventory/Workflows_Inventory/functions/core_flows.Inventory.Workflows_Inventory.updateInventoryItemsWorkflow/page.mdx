...
This documentation provides a reference to the `updateInventoryItemsWorkflow`. It belongs to the `@moetnavss/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/87b5b454afdf7533a167fcb48e069f8c28e4b7e9/packages/core/core-flows/src/inventory/workflows/update-inventory-items.ts#L51" />
...
import { updateInventoryItemsWorkflow } from "@moetnavss/medusa/core-flows"
