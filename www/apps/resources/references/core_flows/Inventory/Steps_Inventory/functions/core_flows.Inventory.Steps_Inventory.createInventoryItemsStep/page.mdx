...
This documentation provides a reference to the `createInventoryItemsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step creates one or more inventory items.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { createInventoryItemsStep } from "@moetnavss/medusa/core-flows"
