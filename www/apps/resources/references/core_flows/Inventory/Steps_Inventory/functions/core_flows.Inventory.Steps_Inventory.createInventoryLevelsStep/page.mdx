...
This documentation provides a reference to the `createInventoryLevelsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step creates one or more inventory levels.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { createInventoryLevelsStep } from "@moetnavss/medusa/core-flows"
...
<TypeList types={[{"name":"CreateInventoryLevelsStepInput","type":"[CreateInventoryLevelsStepInput](../../../../types/core_flows.CreateInventoryLevelsStepInput/page.mdx)","optional":false,"defaultValue":"","description":"The data to create the inventory levels.","expandable":false,"children":[{"name":"inventory_item_id","type":"`string`","description":"The ID of the associated inventory item.","optional":false,"defaultValue":"","expandable":false,"children":[]},{"name":"location_id","type":"`string`","description":"The ID of the associated location.","optional":false,"defaultValue":"","expandable":false,"children":[]},{"name":"stocked_quantity","type":"`number`","description":"The stocked quantity of the associated inventory item in the associated location.","optional":true,"defaultValue":"","expandable":false,"children":[]},{"name":"incoming_quantity","type":"`number`","description":"The incoming quantity of the associated inventory item in the associated location.","optional":true,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="createInventoryLevelsStep"/>
