...
This documentation provides a reference to the `updateInventoryLevelsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step updates one or more inventory levels.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { updateInventoryLevelsStep } from "@moetnavss/medusa/core-flows"
