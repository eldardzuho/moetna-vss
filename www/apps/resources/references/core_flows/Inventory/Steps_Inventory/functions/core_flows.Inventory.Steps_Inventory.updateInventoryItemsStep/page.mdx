...
This documentation provides a reference to the `updateInventoryItemsStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step updates one or more inventory items.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { updateInventoryItemsStep } from "@moetnavss/medusa/core-flows"
