...
This documentation provides a reference to the `deleteCustomersStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more customers.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteCustomersStep } from "@moetnavss/medusa/core-flows"
