...
This documentation provides a reference to the `deleteCustomerAddressesStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step deletes one or more customer addresses.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { deleteCustomerAddressesStep } from "@moetnavss/medusa/core-flows"
