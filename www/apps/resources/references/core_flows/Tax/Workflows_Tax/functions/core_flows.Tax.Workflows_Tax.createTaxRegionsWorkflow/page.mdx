...
This documentation provides a reference to the `createTaxRegionsWorkflow`. It belongs to the `@moetnavss/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/87b5b454afdf7533a167fcb48e069f8c28e4b7e9/packages/core/core-flows/src/tax/workflows/create-tax-regions.ts#L44" />
...
import { createTaxRegionsWorkflow } from "@moetnavss/medusa/core-flows"
