...
This documentation provides a reference to the `refreshInviteTokensStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step refreshes the tokens of one or more invites.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { refreshInviteTokensStep } from "@moetnavss/medusa/core-flows"
