...
This documentation provides a reference to the `addOrderTransactionStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step creates order transactions.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { addOrderTransactionStep } from "@moetnavss/medusa/core-flows"
