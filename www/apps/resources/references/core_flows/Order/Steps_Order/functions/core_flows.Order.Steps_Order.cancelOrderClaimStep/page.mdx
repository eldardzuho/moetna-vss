...
This documentation provides a reference to the `cancelOrderClaimStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

This step cancels a claim.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { cancelOrderClaimStep } from "@moetnavss/medusa/core-flows"
