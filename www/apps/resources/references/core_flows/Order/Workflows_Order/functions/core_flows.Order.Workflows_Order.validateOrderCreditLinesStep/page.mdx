...
This documentation provides a reference to the `validateOrderCreditLinesStep`. It belongs to the `@moetnavss/medusa/core-flows` package.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@moetnavss/framework/workflows-sdk"
import { validateOrderCreditLinesStep } from "@moetnavss/medusa/core-flows"
  ...
  () => {
    const data = validateOrderCreditLinesStep({
      "order": {
        ...
        "status": "archived",
        "currency_code": "lrd",
        "created_at": "2026-04-03T21:02:37.748Z",
        "updated_at": "2026-03-19T12:25:52.771Z",
        "original_item_total": {
          "numeric": 44
        },
