import { SearchTypes } from "@moetnavss/types"
 ...
 *  from the `@moetnavss/utils` package.
 *
 ...
 * import { AbstractSearchService } from "@moetnavss/utils"
 *
  ...
  implements SearchTypes.ISearchService
{
   ...
   * @example
   * // ...
   * import { ProductService } from "@moetnavss/medusa"
   *
