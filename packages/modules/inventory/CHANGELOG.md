...
- [`ca334b7cc1eef297cbde2356746adfd0121d348f`](undefined) - fix(inventory): Adjust inventory level required_quantity when reservation item is deleted through deleteReservationItems from module service
