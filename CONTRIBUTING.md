...
1. Replace the @moetnavss/\* dependencies and devDependencies in you test project's `package.json` to point to the corresponding local packages in your forked Medusa repository. You will also need to add the medusa packages in the resolutions section of the `package.json`, so that every dependency is resolved locally. For example, assuming your forked Medusa project and the test project are sibling directories:

```json
// test project package.json (for npm/yarn)
"dependencies": {
    // more deps
    "@moetnavss/admin-sdk": "file:../medusa/packages/admin/admin-sdk",
    "@moetnavss/cli": "file:../medusa/packages/cli/medusa-cli",
    "@moetnavss/framework": "file:../medusa/packages/core/framework",
    "@moetnavss/medusa": "file:../medusa/packages/medusa",
},
"devDependencies": {
    // more dev deps
    "@moetnavss/test-utils": "file:../medusa/packages/medusa-test-utils",
},
"resolutions": {
    // more resolutions
    "@moetnavss/test-utils": "file:../medusa/packages/medusa-test-utils",
    "@moetnavss/api-key": "file:../medusa/packages/modules/api-key",
    "@moetnavss/auth": "file:../medusa/packages/modules/auth",
    "@moetnavss/cache-inmemory": "file:../medusa/packages/modules/cache-inmemory",
    "@moetnavss/cache-redis": "file:../medusa/packages/modules/cache-redis",
    "@moetnavss/cart": "file:../medusa/packages/modules/cart",
    "@moetnavss/locking": "file:../medusa/packages/modules/locking",
    "@moetnavss/currency": "file:../medusa/packages/modules/currency",
    "@moetnavss/customer": "file:../medusa/packages/modules/customer",
    "@moetnavss/event-bus-local": "file:../medusa/packages/modules/event-bus-local",
    "@moetnavss/file": "file:../medusa/packages/modules/file",
    "@moetnavss/file-local": "file:../medusa/packages/modules/providers/file-local",
    "@moetnavss/fulfillment": "file:../medusa/packages/modules/fulfillment",
    "@moetnavss/fulfillment-manual": "file:../medusa/packages/modules/providers/fulfillment-manual",
    "@moetnavss/index": "file:../medusa/packages/modules/index",
    "@moetnavss/inventory": "file:../medusa/packages/modules/inventory",
    "@moetnavss/medusa": "file:../medusa/packages/medusa",
    "@moetnavss/notification": "file:../medusa/packages/modules/notification",
    "@moetnavss/notification-local": "file:../medusa/packages/modules/providers/notification-local",
    "@moetnavss/order": "file:../medusa/packages/modules/order",
    "@moetnavss/payment": "file:../medusa/packages/modules/payment",
    "@moetnavss/pricing": "file:../medusa/packages/modules/pricing",
    "@moetnavss/product": "file:../medusa/packages/modules/product",
    "@moetnavss/promotion": "file:../medusa/packages/modules/promotion",
    "@moetnavss/rbac": "file:../medusa/packages/modules/rbac",
    "@moetnavss/region": "file:../medusa/packages/modules/region",
    "@moetnavss/sales-channel": "file:../medusa/packages/modules/sales-channel",
    "@moetnavss/stock-location": "file:../medusa/packages/modules/stock-location",
    "@moetnavss/store": "file:../medusa/packages/modules/store",
    "@moetnavss/tax": "file:../medusa/packages/modules/tax",
    "@moetnavss/user": "file:../medusa/packages/modules/user",
    "@moetnavss/workflow-engine-inmemory": "file:../medusa/packages/modules/workflow-engine-inmemory",
    "@moetnavss/link-modules": "file:../medusa/packages/modules/link-modules",
    "@moetnavss/admin-bundler": "file:../medusa/packages/admin/admin-bundler",
    "@moetnavss/admin-sdk": "file:../medusa/packages/admin/admin-sdk",
    "@moetnavss/admin-shared": "file:../medusa/packages/admin/admin-shared",
    "@moetnavss/dashboard": "file:../medusa/packages/admin/dashboard",
    "@moetnavss/admin-vite-plugin": "file:../medusa/packages/admin/admin-vite-plugin",
    "@moetnavss/ui": "file:../medusa/packages/design-system/ui",
    "@moetnavss/icons": "file:../medusa/packages/design-system/icons",
    "@moetnavss/toolbox": "file:../medusa/packages/design-system/toolbox",
    "@moetnavss/ui-preset": "file:../medusa/packages/design-system/ui-preset",
    "@moetnavss/utils": "file:../medusa/packages/core/utils",
    "@moetnavss/types": "file:../medusa/packages/core/types",
    "@moetnavss/core-flows": "file:../medusa/packages/core/core-flows",
    "@moetnavss/orchestration": "file:../medusa/packages/core/orchestration",
    "@moetnavss/cli": "file:../medusa/packages/cli/medusa-cli",
    "@moetnavss/modules-sdk": "file:../medusa/packages/core/modules-sdk",
    "@moetnavss/workflows-sdk": "file:../medusa/packages/core/workflows-sdk",
    "@moetnavss/js-sdk": "file:../../medusa/packages/core/js-sdk",
    "@moetnavss/framework": "file:../medusa/packages/core/framework",
    "@moetnavss/auth-emailpass": "file:../medusa/packages/modules/providers/auth-emailpass",
    "@moetnavss/locking-redis": "file:../medusa/packages/modules/providers/locking-redis",
    "@moetnavss/locking-postgres": "file:../medusa/packages/modules/providers/locking-postgres",
    "@moetnavss/telemetry": "file:../medusa/packages/medusa-telemetry",
    "@moetnavss/settings": "file:../medusa/packages/modules/settings",
    "@moetnavss/draft-order": "file:../medusa/packages/plugins/draft-order",
    "@moetnavss/deps": "file:../medusa/packages/deps",
    "@moetnavss/caching-redis": "file:../medusa/packages/modules/providers/caching-redis",
    "@moetnavss/caching": "file:../medusa/packages/modules/caching",
    "@moetnavss/translation": "file:../medusa/packages/modules/translation",
}
```
